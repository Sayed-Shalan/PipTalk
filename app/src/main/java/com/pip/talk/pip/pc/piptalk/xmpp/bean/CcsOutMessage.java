package com.pip.talk.pip.pc.piptalk.xmpp.bean;
...
public class CcsOutMessage {
	...
	public CcsOutMessage(String to, String messageId, Map<String, String> dataPayload) {
		Log.e("SEND"," inside CCSoutMessage constructor");

		this.to = to;
		this.messageId = messageId;
		this.dataPayload = dataPayload;

		Log.e("SEND"," inside CCSoutMessage constructor , values are,  to :"+this.to+" messageId is :"+this.messageId+" dataPayLoad is :"+this.dataPayload);
