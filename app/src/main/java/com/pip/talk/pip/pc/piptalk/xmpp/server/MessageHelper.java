...
public class MessageHelper {
	...
	public static String createJsonOutMessage(CcsOutMessage outMessage) {
		Log.e("SEND"," inside createJsonOutMessage() , coming value is :"+outMessage);
	...
	public static String createJsonMessage(Map<String, Object> jsonMap) {
		Log.e("SEND"," inside createJsonMessage(), coming value is :"+jsonMap);

		Log.e("SEND"," inside createJsonMessage(), returned value is  :"+JSONValue.toJSONString(jsonMap));
	...
	public static Map<String, Object> createAttributeMap(CcsOutMessage msg) {
		Log.e("SEND"," inside createAttributeMap(), coming value is :"+msg);
		...
		Log.e("SEND"," inside createAttributeMap(), returned value is  :"+map);
